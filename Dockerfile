...
ADD https://nodejs.org/dist/v6.10.0/node-v6.10.0-linux-armv7l.tar.gz /opt/node-v6.10.0-linux-armv7l.tar.gz

RUN tar -xzf /tmp/node-v6.10.0-linux-armv7l.tar.gz && \
